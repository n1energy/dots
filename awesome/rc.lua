...
awful.screen.connect_for_each_screen(function(s)
	...
	--theme.taglist_font = "awesomewm-font 11" and awful.util.tagnames = { "a", "w", "e", "s", "o", "m", "e" }, s, awful.layout.layouts[1])
...
globalkeys = gears.table.join(
    ...
    --Rofi
    awful.key({ modkey }, "d", function() awful.util.spawn("rofi -show drun -display-drun '❯'") end,
